...
Stream either back through the brain's R2 proxy (`brain.streamR2File`), which takes a workspace-relative key and only serves allowlisted prefixes (`brands/`, `projects/`, `workflows/`, and friends). See [Media and files](/guides/media-files).
