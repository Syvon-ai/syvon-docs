...
Only allowlisted prefixes are reachable (`brands/`, `projects/`, `workflows/`, ...). Everything else returns `403`.
...
const tokens = JSON.parse(
  await client.brain.getR2Text('brands/acme/design-tokens.json'),
);
```
